...
- `POSE_PREVIEW_EVERY_N` (default `2` — send 1 preview JPEG every N processed frames)
- `POSE_PREVIEW_MAX_W` (default `280` — downscale width for UDP-friendly JPEG size)
- `POSE_CAMERA_INDEX` (default `0`)
- `POSE_FPS_TARGET` (default `30`)
- `POSE_LEAN_FULL_SCALE` (default `0.20`)
- `POSE_LEAN_DEADZONE` (default `0.035`)
